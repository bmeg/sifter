...
//
// To ensure default values, the struct must have been initialized with NewGetPlaybookParams() beforehand.
func (o *GetPlaybookParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
