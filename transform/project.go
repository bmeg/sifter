...
func valueRender(v interface{}, task *manager.Task, row map[string]interface{}) (interface{}, error) {
...
func (pr ProjectStep) Run(i map[string]interface{}, task *manager.Task) map[string]interface{} {
